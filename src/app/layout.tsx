                    ...
                    <div className="flex items-center">
                        ...
                        <div className="mr-8">
                            <Link href="/" className="flex items-center space-x-3 group cursor-pointer">
                                {/* Logo Icon */}
                                <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-emerald-500 rounded-xl flex items-center justify-center shadow-md transition-all duration-200">
                                    <div className="w-5 h-5 bg-white rounded opacity-90 group-hover:opacity-100 transition-opacity duration-200" />
                                </div>
                                {/* Logo Text */}
                                <h1 className="text-2xl font-bold text-gray-900">Toolmint</h1>
                            </Link>
                        </div>
                        ...
                        <nav className="hidden md:flex items-center space-x-4 ml-4">
                            {[
                                ...
                                <Link
                                    key={item.name}
                                    href={item.href}
                                    className="px-3 py-2 rounded-md text-gray-700 hover:bg-teal-50 transition-colors duration-150"
                                >
                                    {item.name}
                                </Link>
                            ))}
